...
INSERT INTO "new_Room" ("coachesPerTeam", "createdAt", "format", "hostUserId", "id", "knifeRound", "label", "mapPool", "minPlayersToStart", "mode", "overtimeEnabled", "playersPerTeam", "status", "teamAName", "teamBName") SELECT "coachesPerTeam", "createdAt", "format", "hostUserId", "id", "knifeRound", "label", "mapPool", "minPlayersToStart", "mode", "overtimeEnabled", "playersPerTeam", "status", "teamAName", "teamBName" FROM "Room";
DROP TABLE "Room";
